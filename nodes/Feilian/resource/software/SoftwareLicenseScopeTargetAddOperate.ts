...
const SoftwareLicenseScopeTargetAddOperate: ResourceOperations = {
	name: '添加软件许可授权对象',
	value: 'software:license:scope:target:add',
	order: 90,
	options: [
		{
	...
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject> {
		...
		const requestOptions: IHttpRequestOptions = {
			method: 'POST',
			url: '/api/open/v1/software/license/scope/target/add',
			body,
		};
		if (options.timeout) {
...
export default SoftwareLicenseScopeTargetAddOperate;
